...
var Navigation = (function () {
    ...
    Navigation.prototype.openGrid = function (entityTypeName, viewId, showChart, visualizationType, visualizationId, filterExpression, chartDrillDownParameters, viewType) {
        this._customControlProperties.propBagMethods.navigation.openGridPage(entityTypeName, viewId, showChart, visualizationType, visualizationId, filterExpression, chartDrillDownParameters, viewType);
    };
    ...
    Navigation.prototype.openPhoneNumber = function (phoneNumber, useForm, passedEtn, passedId, passedName, executeGlobalHandler) {
        ...
        this._customControlProperties.propBagMethods.navigation.openPhoneNumber(phoneNumber, etn, id, name, reg_etn, reg_id, reg_name, controlLogicalName, this._customControlProperties.contextToken, useForm, executeGlobalHandler);
    };
    ...
    Navigation.prototype.navigateTo = function (input, options) {
        return XrmProxyInstance.navigateTo(input, options);
    };
