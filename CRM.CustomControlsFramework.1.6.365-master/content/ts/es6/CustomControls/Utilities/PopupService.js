...
var PopupService = (function () {
    ...
    PopupService.prototype.renderPopups = function () {
        ...
        return result.length ? (React.createElement(RootPopup, { id: popupsId, parentCustomControlId: this._host.props.controlId, openPopup: this._host.props.actions.openPopup, closePopup: this._host.props.actions.closePopup, rootBodyElement: this._host.props.rootBodyElement, customZIndex: this._host.props.zIndexOverride }, result)) : null;
    };
    return PopupService;
}());
export { PopupService };
