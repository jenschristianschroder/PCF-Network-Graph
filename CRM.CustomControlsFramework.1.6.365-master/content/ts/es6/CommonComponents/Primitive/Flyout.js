...
var Flyout = (function (_super) {
    ...
    Flyout.prototype.updateDom = function () {
        ...
        if (this.props.children) {
            ...
            var combinedStyle = Object.assign({}, this.props.flyoutStyle, this.calculatePosition(), { boxSizing: "border-box" }, this.props.rootZIndex || shouldHaveZIndex ? { zIndex: 1 } : {}, isIE && this._flyoutElement === undefined ? { left: 0 } : {}, isIE ? { display: "initial" } : {});
            ...
            var flyoutView = (React.createElement(View, __assign({ id: this.props.id, style: combinedStyle, ref: this.setFlyoutRef, onClick: function (e) { return e.stopPropagation(); } }, this.props), this.props.children));
