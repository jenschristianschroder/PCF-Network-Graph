...
var InnerComboBox = (function (_super) {
    ...
    InnerComboBox.prototype._handleMove = function (amount) {
        ...
        this._setCurrentItemByVisibleIndex(selectedIndexNew, !!this.props.freeTextMode);
            ...
            if (options.length) {
                ...
                var scrollToElementId = this.keyboardScrolling || handleOption
                    ...
                    : this.selectedListItem && this.selectedListItem.props.id
                        ...
                        : undefined;
                return (React.createElement(List, { id: this.getListId(), key: this.getListId(), role: roles.LISTBOX, style: listStyle, tabIndex: 0, onKeyDown: this.keyboardNavigation },
    ...
    InnerComboBox.prototype.renderTextOnly = function (controlId, testHooks) {
        ...
        return (React.createElement(Text, __assign({ id: controlId, key: controlId, testhooks: testHooks, accessibilityHasPopup: true, accessibilityExpanded: this.state.isExpanded, accessibilityRequired: this.props.accessibilityRequired, accessibilityLabel: this.props.accessibilityLabel ? this.props.accessibilityLabel : this.getSelectedOptionText(), title: this.props.title, describedByElementId: this.props.describedByElementId ? this.props.describedByElementId : valueId, ref: this.saveTextRef, role: this.props.useHeader ? null : roles.BUTTON, onClick: this.handleEnterKey, onFocus: this.handleInnerControlFocus, onBlur: this.handleInnerControlBlur, onKeyDown: this.handleKeyDown, tabIndex: this.props.readOnly ? -1 : 0, semanticTag: this.props.useHeader ? "h1" : null, style: textStyle }, elementProps),
...
var ComboBox = ReactFela.connect(mapStylesToProps)(InnerComboBox);
