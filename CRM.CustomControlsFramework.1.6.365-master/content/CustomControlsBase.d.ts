...
declare module "CustomControls/Models/Dataset/CustomControlDataSetInterfaces" {
     ...
     * @license Copyright (c) Microsoft Corporation. All rights reserved.
     */
    import { DataProviderCapabilities as DataSetCapabilites, DataSetEntityRecord } from "CustomControls/Models/Dataset/CustomControlDataProviderInterfaces";
    import { AttributeMetadata } from "CustomControls/Models/CustomControlMetadataInterfaces";
    /**
...
declare module "CustomControls/Models/Dataset/CustomControlDataProviderInterfaces" {
    ...
    import { FilterExpression, DataSetColumnSortStatus, LinkEntityExpression, DataSetColumn, ColumnInfo, onDataSetUpdatedCallback, DataSet } from "CustomControls/Models/Dataset/CustomControlDataSetInterfaces";
    /**
...
declare module "CustomControls/Models/Dataset/DataSetObjectWrapper" {
    ...
    import { DataSet } from "CustomControls/Models/Dataset/CustomControlDataSetInterfaces";
    /**
...
declare module "CustomControls/Models/Dataset/DataSetFactory" {
    ...
    class DataSetFactory {
         ...
         * To be used in external repo which donot have full PCF lifecycle support.
...
declare module "CustomControls/Models/CustomControlDataInterfaces" {
    ...
    interface ICustomControlHostDispatchPropsActions {
        ...
        retrieveRecordDataForForm: (entityReference: CustomControlEntityReference, formId: string, processControlDataRequest?: object, // eslint-disable-line @typescript-eslint/ban-types
        additionalColumns?: string[], isPrimaryAttributeRequested?: boolean) => Promise<any>;
    ...
    interface INavigationDispatch {
         ...
         */
        openGridPage(entityTypeName: string, viewId?: string, showChart?: boolean, visualizationType?: number, visualizationId?: string, filterExpression?: string, chartDrillDownParameters?: CustomControlInterfaces.ChartDrillDownParameter[], viewType?: number): void;
        openDashboard(id: string): void;
        openCreateForm(logicalName: string, initialValues?: Dictionary, createFromEntity?: CustomControlEntityReference): void;
        openSearch(query?: string): void;
        openPowerBIFullScreenPage(powerBIEmbedUrl?: string, powerBIGroupId?: string, powerBIDashboardId?: string, powerBITileId?: string, powerBIReportId?: string, powerBIReportUrl?: string, powerBIComponentTypeCode?: string): void;
        ...
        openUrlWithProtocol(url: string, protocol: string): void;
        openPhoneNumber(phoneNumber: string, to_etn: string, to_id: string, to_name: string, regarding_etn?: string, regarding_id?: string, regarding_name?: string, controlLogicalName?: string, contextToken?: any, openFormOnEnd?: boolean, executeGlobalHandler?: boolean): void;
        openMaps(address: string): void;
        openMap(address: string): void;
    }
...
declare module "CustomControls/Utilities/XrmProxyDefaultUtilities" {
    ...
    export function openAlertDialog(strings: ControlAndClientApiInterfaces.AlertDialogStrings): Promise<ControlAndClientApiInterfaces.AlertDialogResponse>;
    export function openErrorDialog(strings: ControlAndClientApiInterfaces.ErrorDialogOptions): Promise<ControlAndClientApiInterfaces.ErrorDialogResponse>;
    export function openConfirmDialog(strings: ControlAndClientApiInterfaces.ConfirmDialogStrings): Promise<ControlAndClientApiInterfaces.ConfirmDialogResponse>;
}
...
declare module "CustomControls/Utilities/CustomControlHelper" {
     ...
     */
    function areFilteringObjEqual(firstFilteringObj: CustomControlInterfaces.FilterExpression, secondFilteringObj: CustomControlInterfaces.FilterExpression): boolean;
    /**
...
declare module "CustomControls/Utilities/ManifestDesignHelper" {
    ...
    import { IDesignBag } from "CustomControls/Models/CustomControlExposedInterfaces";
    /**
...
declare module "CustomControls/Models/Dataset/MockDataProvider" {
    ...
    import { DataSetColumn, onDataSetUpdatedCallback, DataSet, DataSetRecord, ColumnInfo } from "CustomControls/Models/Dataset/CustomControlDataSetInterfaces";
...
declare module "CommonComponents/Common/ViewSelectorControl" {
    ...
    interface IViewSelectorControlProps extends IComboBoxProps {
        ...
        isRTL?: boolean;
        /**
         * use enhanced UI for view selector
         */
    ...
    class ViewSelectorControl extends InnerComboBox<IViewSelectorControlProps, IViewSelectorControlState> {
        ...
        /**
         * get icon position via props. View Selector V2 must be enabled.
         */
        ...
        /**
         * Flyout relative item is Caret button
         * If View Selector V2 is enabled, set relative item to container of Text and Caret button
         * and change flyout direction
         * @param isRTL
         */
...
declare module "CommonComponents/Primitive/ProgressIndicator" {
     ...
     */
    class InnerProgressIndicator extends ComponentBase<IProgressIndicatorProps, ProgressIndicatorState> {
        static displayName: string;
